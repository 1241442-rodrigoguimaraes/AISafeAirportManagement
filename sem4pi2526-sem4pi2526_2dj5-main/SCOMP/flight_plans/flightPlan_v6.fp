flight PT33D {
    ...
    leg {
        ...
        segment {
            mode:           climb
            start: { latitude: 41.2421   longitude: -8.6785   altitude: 69    m }
            end:   { latitude: 40.7500   longitude: -8.6500   altitude: 7000  m }
        ...
        segment {
            ...
            end:   { latitude: 39.4000   longitude: -8.9000   altitude: 7315  m }
        ...
        segment {
            ...
            end:   { latitude: 38.7813   longitude: -9.1359   altitude: 114   m }
