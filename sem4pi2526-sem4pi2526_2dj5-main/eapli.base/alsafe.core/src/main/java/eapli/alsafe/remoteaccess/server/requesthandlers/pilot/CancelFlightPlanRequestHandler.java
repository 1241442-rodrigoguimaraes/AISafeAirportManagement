...
public class CancelFlightPlanRequestHandler implements RemoteAccessRequestHandler {
    ...
    public Packet handle(final Packet packet) {
        try {
            ...
            controller.cancelPlan(plan);
            return success("Flight plan cancelled successfully: " + plan.identity());
